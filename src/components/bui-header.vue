    ...
    <div class="bui-header-box" :style="{'height': height, 'background-color': backgroundColor}">
        ...
        <div class="bui-header">
            ...
            <div class="bui-header-left">
                <bui-icon @click="_leftClick($event)" v-if="leftItem.icons" :name="leftItem.icons" size="45px" color="#ffffff" class="pdr10"></bui-icon>
                <text @click="_leftClick($event)" v-if="leftItem.text" class="bui-header-text">{{leftItem.text}}</text>
                <slot name="left"></slot>
            </div>
            <div class="bui-header-right">
                <bui-icon @click="_rightClick($event)" v-if="rightItem.icons" :name="rightItem.icons" size="45px" color="#ffffff" class="pdl10"></bui-icon>
                <text @click="_rightClick($event)" v-if="rightItem.text" class="bui-header-text">{{rightItem.text}}</text>
